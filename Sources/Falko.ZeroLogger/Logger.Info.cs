...
public readonly partial struct Logger
{
    ...
    public void Info<T1, T2, T3, T4, T5>([Localizable(false)][StructuredMessageTemplate] string? message,
        T1 argument1,
        T2 argument2,
        T3 argument3,
        T4 argument4,
    ...
    public void Info<T1, T2, T3, T4, T5>(Exception? exception, [Localizable(false)][StructuredMessageTemplate] string? message,
        T1 argument1,
        T2 argument2,
        T3 argument3,
        T4 argument4,
    ...
    public void Info<T1, T2, T3, T4, T5>(LogMessageFactory message,
        T1 argument1,
        T2 argument2,
        T3 argument3,
        T4 argument4,
    ...
    public void Info<T1, T2, T3, T4, T5>(Exception? exception, LogMessageFactory message,
        T1 argument1,
        T2 argument2,
        T3 argument3,
        T4 argument4,
